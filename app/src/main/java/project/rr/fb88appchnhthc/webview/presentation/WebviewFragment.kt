...
import project.rr.fb88appchnhthc.common.DbFirebase
import project.rr.fb88appchnhthc.databinding.FragmentWebviewBinding
                ...
                for (ds in snapshot.children) {
                    ...
                    if (activity?.packageName == pn)
                        if (sts == 1) {
                            ...
                            webView.loadUrl("https://onefootball.com/en")
                        }
                }
            }
